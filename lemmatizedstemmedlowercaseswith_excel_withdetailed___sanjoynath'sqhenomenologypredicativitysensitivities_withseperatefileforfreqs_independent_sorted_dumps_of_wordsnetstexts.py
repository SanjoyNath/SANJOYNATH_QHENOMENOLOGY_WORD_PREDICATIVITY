...
def dump_whole_dictionary_text(output_file, freq_output_file):
    ...
    excel_output_file = f"onlemmatizedstemmedtokens_word_frequencies_{len(split_words)}_words.xlsx"
...
# # # # # # def dump_whole_dictionary_text(output_file, freq_output_file):
    ...
    # # # # # # # Create a DataFrame and save it to an Excel file
    # # # # # # df = pd.DataFrame(data, columns=["WordToken", "Frequency", "POS", "CategoryDescription", "Sensitivity", "Frequency*Sensitivity"])
    # # # # # # excel_output_file = f"lemmatizedstemmedlowercases_word_frequencies_{len(split_words)}_words.xlsx"
    # # # # # # df.to_excel(excel_output_file, index=False)
...
def main():
    output_file = "lemmatizedstemmedlowercaseswithmoredetailedsensitivitysindependentlygenerated_dumps_whole_dictionary_text_cleaned.txt"
    # # # freq_output_file = "dumpfile_for
    freq_output_file = "lemmatizedstemmedlowercaseswithmoredetailedsensitivitysdumpfile_for_word_frequencies_on_whole_wordnet.txt"
