...
def main():
    try:
        ...
        wordnet_data.to_excel("forhuntergatherers_withsubstringsnonspecialcharsrevisedweightsdescendingonfreqsprodssensts_enhanced_wordnet_data_sorted.xlsx", index=False, engine='openpyxl')
