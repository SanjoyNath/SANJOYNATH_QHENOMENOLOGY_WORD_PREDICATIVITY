...
def dump_whole_dictionary_text(output_file, freq_output_file):
    ...
    excel_output_file = f"word_frequencies_{len(split_words)}_ancientness_sensitivity_words.xlsx"
...
def main():
    output_file = "ancientnesssensitivity_independentlygenerated_dumps_whole_dictionary_text_cleaned.txt"
    freq_output_file = "ancientnesssensitivity_dumpfile_for_word_frequencies_on_whole_wordnet.txt"
