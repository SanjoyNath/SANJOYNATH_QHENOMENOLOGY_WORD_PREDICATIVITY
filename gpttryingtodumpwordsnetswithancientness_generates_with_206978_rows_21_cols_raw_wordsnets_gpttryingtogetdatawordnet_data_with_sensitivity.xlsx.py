...
def main():
    ...
    try:
        ...
        # Export to Excel
        wordnet_df.to_excel('gpttryingtogetdatawordnet_data_with_sensitivity.xlsx', index=False, engine='openpyxl')
        print("WordNet data with sensitivity has been exported to 'wordnet_data_with_sensitivity.xlsx'.")
    except Exception as e:
